...
typedef UINT(WINAPI* GetDriveTypeW_typedef)(LPCWSTR lpRootPathName);
...
typedef BOOL(WINAPI* GetVolumeInformationW_typedef)(LPCWSTR lpRootPathName, LPWSTR lpVolumeNameBuffer, DWORD nVolumeNameSize, LPDWORD lpVolumeSerialNumber, LPDWORD lpMaximumComponentLength, LPDWORD lpFileSystemFlags, LPWSTR lpFileSystemNameBuffer, DWORD nFileSystemNameSize);
